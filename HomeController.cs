...
namespace LicensePortal_APPAPI.Controllers
{
    ...
    public class HomeController : ControllerBase
    {
        ...
        public LicenseInfo GenerateLicense([FromBody] LicenseInfo licensedetails)
        {
            ...
            string[] values = licensedetails.CustList.Split(',');
            if (values != null)
            {
                for(var i=0;i<values.Length;i++)
                {
                    dict.Add(values[i].ToString(), "Yes");
                }
            }
        ...
        string UserName = licensedetails.UserName;
            ...
            .As(licensedetails.LicenseType == "Trial" ? Portable.Licensing.LicenseType.Trial : Portable.Licensing.LicenseType.Standard)
